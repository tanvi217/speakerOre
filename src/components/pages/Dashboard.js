      ...
      <Content className='site-layout' style={{ padding: '1.5% 5%' }}>
        <Layout className='site-layout-background' style={{ padding: '2% 3%' }}>
          ...
          >
            ...
            >
              <Menu.Item disabled>Users</Menu.Item>
              <Menu.Item key='users' onClick={() => setDisplay(<Users />)}>
                <UserOutlined style={{ color: '#328fce' }} />
                Users
              </Menu.Item>
              <Menu.Divider></Menu.Divider>

              <Menu.Item disabled>Events</Menu.Item>
              <Menu.Item key='5' onClick={() => setDisplay(<Pending />)}>
                <IssuesCloseOutlined style={{ color: '#328fce' }} />
                Pending
              </Menu.Item>
              <Menu.Item key='6' onClick={() => setDisplay(<Accepted />)}>
                <CheckOutlined style={{ color: '#328fce' }} />
                Accepted
              </Menu.Item>
              <Menu.Item key='7' onClick={() => setDisplay(<Declined />)}>
              ...
              <Menu.Item disabled>Coupons</Menu.Item>
              <Menu.Item
                key='coupon'
                onClick={() => setDisplay(<CouponForm />)}
              >
              ...
              <Menu.Item disabled>SUBSCRIPTION</Menu.Item>
              <Menu.Item
                key='subscribe'
                onClick={() => setDisplay(<Subscription />)}
              >
              ...
              <Menu.Item disabled>Extras</Menu.Item>
              ...
              <Menu.Item disabled>TRANSATIONS</Menu.Item>
