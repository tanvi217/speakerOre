...
export const GET_EVENTS_BY_PAGE = 'GET_EVENTS_BY_PAGE';
...
export const GET_UPDATED_PRICE = 'GET_UPDATED_PRICE';
export const COUPON_ERROR = 'COUPON_ERROR';
export const CLEAR_COUPON_ERROR = 'CLEAR_COUPON_ERROR';
export const TOGGLE_COUPON_VISIBILITY = 'TOGGLE_COUPON_VISIBILITY';
...
export const GET_SPECIFIC_SUBSCRIPTION_PLAN = 'GET_SPECIFIC_SUBSCRIPTION_PLAN';
